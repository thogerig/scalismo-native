...
object Build extends sbt.Build {
  ...
  //
  lazy val productVersion = "5.0.0-SNAPSHOT"
  ...
  lazy val impl_linux64 = implProject("linux64", Some("windows_amd64"))
  lazy val impl_win64 = implProject("windows64", Some("linux_amd64"))

  lazy val root = Project(id = "scalismo-native", base = file(".")) aggregate(stub, impl_all, impl_linux64, impl_win64)
