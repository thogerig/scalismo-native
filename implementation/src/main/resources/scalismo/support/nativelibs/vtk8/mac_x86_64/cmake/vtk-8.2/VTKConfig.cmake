...
set(_vtk_installed_prefix "/Users/madsen/vtk-install/lib/cmake/vtk-8.2")
...
if (_vtk_installed_prefix_full STREQUAL _vtk_requested_prefix_full)
  set(VTK_INSTALL_PREFIX "/Users/madsen/vtk-install")
else ()
...
if (__vtk_install_tree)
  if (WIN32)
    set (VTK_RUNTIME_DIRS "/Users/madsen/vtk-install/bin")
  else ()
    set (VTK_RUNTIME_DIRS "/Users/madsen/vtk-install/lib")
  endif ()
else()
  if (WIN32)
    set (VTK_RUNTIME_DIRS "/Users/madsen/workspace/uni/libraries/vtk/vtkbuild/bin")
  else ()
    set (VTK_RUNTIME_DIRS "/Users/madsen/workspace/uni/libraries/vtk/vtkbuild/lib")
  endif ()
endif()
